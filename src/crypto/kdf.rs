...
mod tests {
    ...
    fn derive_official_eth_pbkdf2() {
        let kdf = Pbkdf2 {
            dklen: 32,
            c: 8,
            salt: hex::decode("ae3cd4e7013836a3df6bd7241b12db061dbe2c6785853cce422d148a624ce0bd").unwrap(),
    ...
    fn derive_fast_pbkdf2_32() {
        let kdf = Pbkdf2 {
            dklen: 32,
            c: 1024,
            salt: hex::decode("07739140252caf31150004f25f0d0b918e41c82ca9a49c12742461a9c28a1033").unwrap(),
            prf: PrfType::HmacSha256
        };
    ...
    fn derive_scrypt_fast_32() {
        let kdf = ScryptKdf {
            dklen: 32,
            salt: hex::decode("d72c87d0f077c7766f2985dfab30e8955c373a13a1e93d315203939f542ff86e").unwrap(),
            n: 1024,
            r: 8,
            p: 1
        };
    ...
    fn derive_scrypt_with_zero() {
        let kdf = ScryptKdf {
            dklen: 32,
            salt: hex::decode("7dc589ffcb9766699442ff5b0f254bd9455861cd00019e5617b99c0dd507eff8").unwrap(),
            n: 1024,
            r: 8,
            p: 1
        };
