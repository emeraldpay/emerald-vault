...
*Parameters*:
    ...
    ** `function` (Object, optional) - Smart contract function abi selector to encode and use as `data`
    *** `name` (String) - Not constant function to change smart contract internal state
...
*Parameters*:
    ...
    ** `address` (String, optional) - hex-encoded 20 bytes public address
