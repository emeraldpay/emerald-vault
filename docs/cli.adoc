...
=== How to exclude some account from the showing list
...
----
emerald new --chain testnet --security-level high "Test account" < echo "1234567890"
----

=== How to show private key

----
emerald strip --chain testnet 0x0e7c045110b8dbf29765047380898919c5cb56f4
----

=== How to change `passphrase`

----
emerald strip --chain testnet 0x0e7c045110b8dbf29765047380898919c5cb56f4 < echo "old passphrase" > <temp_file>
emerald new --chain testnet --raw < <temp_file> < echo "new passphrase"
----
