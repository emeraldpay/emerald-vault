...
CLI_ARCHIVE_NAME="emerald-cli-mac-v$APP_VERSION_GIT_TAG"
...
openssl aes-256-cbc -d -in .circleci/gcloud-circleci.json.enc -k $GCP_PASSWD -out gcloud-circleci.json
